                ...
                var selector = attr.selector
                    ...
                    , showCalendar = function showCalendar() {
                        ...
                        if (theCalendar.classList) {
                            ...
                            //    if (!isNaN(Date.parse(preFinalDate))) {
                            //        //alert("das");
                            //       // date = new Date(dateString);
                            //        //var v = dateString.split("/").reverse().join("-");
                            //        //var rDate = new Date(dateString.split("/").reverse().join("-"));
                            //        //var nDate = (rDate.getMonth() + 1) + '/' + rDate.getDate() + '/' + rDate.getFullYear();

                            //        //var datePieces = dateString.split("-");
                            //        //var preFinalDate = new Date(parseInt(datePieces[2]), parseInt(datePieces[1]) - 1, parseInt(datePieces[0]));

                            //       // var rDate = new Date(preFinalDate);

                            //        $scope.month = $filter('date')(preFinalDate, 'MMMM');//december-November like
                            //        $scope.monthNumber = Number($filter('date')(preFinalDate, 'MM')); // 01-12 like
                            //        $scope.day = Number($filter('date')(preFinalDate, 'dd')); //01-31 like
                            //        $scope.year = Number($filter('date')(preFinalDate, 'yyyy'));//2014 like
