app.controller("myCtrl", function ($scope, $http, uiGridConstants) {
    ...
    var columnZWiseSalesAchValueList = [
        ...
        { name: "CM_MPO", displayName: "CM MPO", cellFilter: 'number' , aggregationType: uiGridConstants.aggregationTypes.sum, width: 80, cellClass: 'grid-align', footerCellFilter: 'number:2'},
        { name: "LM_MPO", displayName: "LM MPO", cellFilter: 'number' , aggregationType: uiGridConstants.aggregationTypes.sum, width: 80, cellClass: 'grid-align', footerCellFilter: 'number:2'},
